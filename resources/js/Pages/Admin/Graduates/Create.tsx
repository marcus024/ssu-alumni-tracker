...
export default function Create({ departments }: CreateProps) {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        post(route('admin.graduates.store'));
    };
    ...
    return (
        <AdminLayout>
            <Head title="Create Graduate Record" />
            <div className="py-6">
                <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
                        <div className="flex justify-between items-center mb-6">
                            <div>
                                <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Create Graduate Record</h2>
                                <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">Complete Graduate Tracer Survey - Step {currentStep} of {totalSteps}</p>
                            </div>
                            <Link href={route('admin.graduates.index')} className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200">Back to List</Link>
                        </div>
                        ...
                        <form onSubmit={submit}>
                                ...
                                <div className="space-y-6 max-h-[70vh] overflow-y-auto pr-2">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <select id="year" value={data.year} className={selectClass} onChange={(e) => setData('year', parseInt(e.target.value))} required>
                            ...
                            {currentStep === 3 && (
                                <div className="space-y-6 max-h-[70vh] overflow-y-auto pr-2">
                                    <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 border-b border-gray-200 dark:border-gray-700 pb-2">Professional Examination (Optional)</h3>
                                    ...
                                    <div className="pt-6 border-t border-gray-200 dark:border-gray-700">
                                        <h4 className="text-md font-semibold text-gray-900 dark:text-gray-100 mb-4">Relevant Trainings/Seminars Attended (Optional)</h4>
                            ...
                            {currentStep === 5 && data.ever_employed === 'No' && (
                                <div className="text-center py-12">
                                    <p className="text-gray-600 dark:text-gray-400">Employment details section is not applicable since the graduate has not been employed.</p>
                                    <p className="text-sm text-gray-500 dark:text-gray-500 mt-2">Click "Create Record" to complete the form.</p>
                                </div>
                            )}
                            ...
                            <div className="flex justify-between pt-6 border-t border-gray-200 dark:border-gray-700 mt-6">
                                ...
                                <div className="flex gap-4">
                                    <Link href={route('admin.graduates.index')} className="px-6 py-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200">
                                        Cancel
                                    </Link>
