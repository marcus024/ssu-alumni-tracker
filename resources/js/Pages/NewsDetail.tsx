...
import { News, SchoolInfo } from '@/types';
...
export default function NewsDetail({ news, schoolInfo }: NewsDetailProps) {
    ...
    return (
        <>
            <Head title={`${news.title} - SSU Alumni News`} />
                            ...
                            <div className="text-white max-w-4xl">
                                ...
                                >
                                    <div className="flex items-center">
                                        ...
                                        <span className="text-lg">{formatDate(news.created_at)}</span>
                                    </div>
                                </motion.div>
                            </div>
                        </div>
                            ...
                            >
                                ...
                                <div className="flex items-center gap-4 text-sm text-gray-600 dark:text-gray-400 mb-8 pb-8 border-b border-gray-200 dark:border-gray-700">
                                    <div className="flex items-center">
                                        ...
                                        Published on {formatDate(news.created_at)}
                                    </div>
                                    {news.updated_at !== news.created_at && (
                                        <div className="flex items-center">
                                            ...
                                            Updated on {formatDate(news.updated_at)}
                                        </div>
                                    )}
                                </div>
