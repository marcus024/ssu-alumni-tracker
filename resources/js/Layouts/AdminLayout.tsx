...
export default function AdminLayout({ header, children }: AdminLayoutProps) {
    ...
    const navigation = [
        ...
        { name: 'Graduates', href: '/admin/graduates', icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z' },
        ...
        { name: 'School Info', href: '/admin/school-info', icon: 'M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
